import { buildEventDetailsText } from '../content/weddingInfoPages';
...
/**
 * Generates the full wedding info PDF (all event detail pages) client-side
 * and triggers a browser download. Shared by InfoPageOverlay (About room)
 * and the "WEDDING INFO PDF" social barrel in ContactRoom.
 */
export const downloadEventDetailsPdf = () => {
